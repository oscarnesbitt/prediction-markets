...
Prediction market prices reflect the crowd's aggregate probability estimate. When new information enters the market, such as a data release or news event, prices should update to reflect the new evidence. In practice, markets often lag, especially in thinner markets or immediately after a surprise.
